  ...
  return (
    ...
    >
        <Box
            ...
            ml={"20px"}
        >
            <img src="../images/vapepod.png" alt="vapedevice" id="vapepod"/>
            <Stack
                direction={"column"}
                alignItems={"center"}
            >
                <Typography variant="h4" sx={{color: "white"}}>Pods</Typography>
                <Typography sx={{color: "white"}}>Variety of choices available</Typography>
            </Stack>
        </Box>
        <CarouselProvider
