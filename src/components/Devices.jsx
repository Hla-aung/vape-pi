  ...
  return (
    ...
    >
        <Box
            ...
            ml={"20px"}
        >
            <img src="../images/vapedevice.png" alt="vapedevice" id="vapedevice"/>
            <Stack
                direction={"column"}
                alignItems={"center"}
            >
                <Typography variant="h4" sx={{color: "white"}}>Devices</Typography>
                <Typography sx={{color: "white"}}>Find the best for you</Typography>
            </Stack>
        </Box>
        <CarouselProvider
